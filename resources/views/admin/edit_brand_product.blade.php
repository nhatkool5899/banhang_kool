            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        <form action="{{URL::to('/update-brand-product/'.$edit_value->brand_id)}}" method="POST" class="form-horizontal" role="form">
                            {{ csrf_field() }}
                        <div class="form-group">
                            <label class="col-lg-3 col-sm-3 control-label">Tên thương hiệu</label>
                            <div class="col-lg-9">
                                <input type="text" value="{{ $edit_value->brand_name }}" class="form-control" name="brand_product_name" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2">
                                <select name="brand_product_status" class="form-control">
                                    <?php if ($edit_value->brand_status == 0) {
                                    ?>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-3 col-lg-10">
                                <button type="submit" name="update_brand_product" class="btn btn-success">Update</button>
                            </div>
                        </div>
