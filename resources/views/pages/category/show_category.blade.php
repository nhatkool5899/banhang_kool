...
<div class="features_items"><!--features_items-->
    @foreach ($category_name as $item =>$category_name_id)
    <div style="margin-bottom: 20px">
        <span class="title-category">
            Danh mục <i class="fa-solid fa-circle-chevron-right"></i>
        </span>
        <span class="title-category-name">{{ $category_name_id->category_name }}</span>
    </div>
    @endforeach
